...
SDL_AppResult SDL_AppInit (void** appstate, int argc, char** argv) {
    ...
    // box transform
    add_transform (
        box, (vec3) {-1.0f, 0.0f, 0.0f}, (vec3) {0.0f, 0.0f, 0.0f},
        (vec3) {1.0f, 1.0f, 1.0f}
    );
    ...
    add_transform (
        tbox, (vec3) {1.0f, 0.0f, 0.0f}, (vec3) {0.0f, 0.0f, 0.0f},
        (vec3) {1.0f, 1.0f, 1.0f}
    );
...
SDL_AppResult SDL_AppIterate (void* appstate) {
    ...
    add_transform (
        box, box_transform.position, box_rotation, box_transform.scale
    );
    ...
    add_transform (
        tbox, tbox_transform.position, tbox_rotation, tbox_transform.scale
    );
