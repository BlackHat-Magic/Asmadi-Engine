...
SDL_AppResult SDL_AppInit(void** appstate, int argc, char** argv) {
    ...
    MaterialComponent icosahedron_material = create_phong_material ((vec3) {1.0f, 1.0f, 1.0f}, SIDE_FRONT, state);
    add_material (icosahedron, icosahedron_material);
    // icosahedron transform
    add_transform(icosahedron, (vec3) {0.0f, 0.0f, 0.0f}, (vec3){0.0f, 0.0f, 0.0f}, (vec3){1.0f, 1.0f, 1.0f});
