...
SDL_AppResult SDL_AppInit(void** appstate, int argc, char** argv) {
    ...
    MaterialComponent tetrahedron_material = create_phong_material ((vec3) {1.0f, 1.0f, 1.0f}, SIDE_FRONT, state);
    add_material (tetrahedron, tetrahedron_material);
    // tetrahedron transform
    add_transform(tetrahedron, (vec3) {0.0f, 0.0f, 0.0f}, (vec3){0.0f, 0.0f, 0.0f}, (vec3){1.0f, 1.0f, 1.0f});
